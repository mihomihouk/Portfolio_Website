...
function VisitorCountChart({visitorCount}:{visitorCount: VisitorAnalyticsResponseData['visitorCount']} ){
...
function PageViewChart({ pagePopularity }:{ pagePopularity:VisitorAnalyticsResponseData['pagePopularity'] }){
